  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-900">모임 후기</h1>
        <Link href="/recaps/new">
          <Button>
      ...
      {recaps && recaps.length > 0 ? (
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {recaps.map((recap) => (
            <Link key={recap.id} href={`/recaps/${recap.id}`}>
              <Card className="h-full hover:border-blue-300 transition-colors overflow-hidden">
                ...
                <CardContent className="pt-4">
                  ...
                  <p className="text-sm text-gray-600 line-clamp-2">
                    {recap.content.replace(/[#*`]/g, '').slice(0, 100)}...
                  </p>
        ...
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <p className="text-gray-500 mb-4">아직 모임 후기가 없습니다</p>
            <Link href="/recaps/new">
